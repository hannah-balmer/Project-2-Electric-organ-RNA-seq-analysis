...
# SRR25630296 reverse stranded 
/usr/bin/time -v pixi run htseq-count --format=sam --stranded=reverse --mode=union --idattr=Parent $SAM_296 $DATA/campylomormyrus.gff > SRR25630296.rev.tsv